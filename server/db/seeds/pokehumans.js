...
exports.seed = async function (knex) {
  ...
  await knex('pokehumans').insert([
    ...
    { id: 3, name: 'Ironryan', type_1: 'Steel', type_2: 'Electirc', HP: 10, attack: 59, defence: 91, Sp_attack: 53, Sp_defence: 55, speed: 42, image: 'https://sg.portal-pokemon.com/play/resources/pokedex/img/pm/600318f01f6fb95bbdaaebfd21644d1caefd43a7.png' },
